...
stages = [
    {"wet_mass": 236000, "fuel_mass": 128000, "thrust1": 33_850_000, "thrust2": 35_000_000, "burn_time": 70, "ejection_force": 200},
    {"wet_mass": 200000, "fuel_mass": 141000, "thrust1": 4_450_000, "thrust2": 5_095_000, "burn_time": 150, "ejection_force": 250},
]
...
plt.plot(time_data, adjusted_altitude, label='Матмодель: Высота', color='orange', marker='o', linewidth=0.8, markersize=2)
...
plt.plot(time_data, adjusted_speed, label='Матмодель: Скорость', color='orange', marker='o', linewidth=0.8, markersize=2)
